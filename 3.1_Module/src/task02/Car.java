...
public class Car {
    ...
    public void accelerate() {
        if (gasolineLevel > 0) {
            ...
            if (speed == maxSpeed) {
                System.out.println(this.typeName + ": Max speed reached!");
            }
            if (gasolineLevel == 0) {
                speed = 0;
                System.out.println(this.typeName + ": Ran out of gas!");
            }
        } else {
            speed = 0;
            System.out.println(this.typeName + ": No gas!");
        }
    }
    ...
    public static void printCarDetails(Car car) {
        System.out.println(car.getTypeName() + ": Speed now: " + car.getSpeed() + " km/h, gas: " + car.getGasolineLevel());
    }
}
